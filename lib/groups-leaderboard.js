...
export function calculateMemberScore(solves, firstTrySolves, longestStreak, avgGuesses) {
 ...
 */
export function buildMemberStats(member, guessRows, caseLookup) {
 ...
 * @param {Record<string, CaseRow>} caseLookup
 */
export function buildGroupAggregatesFromRows(groups, members, guessRows, caseLookup) {
  return groups
    .map(group => {
